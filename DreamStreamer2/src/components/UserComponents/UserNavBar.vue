      ...
      <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <PopoverGroup class="hidden lg:flex lg:gap-x-12">
          <!-- <Popover class="relative">
            <PopoverButton class="flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-200">
              Product
              <ChevronDownIcon class="h-5 w-5 flex-none text-gray-200" aria-hidden="true" />
            </PopoverButton>
          ...
          <a href="#" class="text-sm font-semibold leading-6 text-gray-200">Songs</a>
          <a href="#" class="text-sm font-semibold leading-6 text-gray-200">Library</a>
        </PopoverGroup>
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
          <button @click="toggleSignOut" class="text-sm font-semibold leading-6 text-gray-200">Sign Out</button>
        </div>
      </nav>
          ...
          <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/10">
              <div class="space-y-2 py-6">
                ...
                <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Songs</a>
